...
const file_device_proto_rawDesc = "" +
	"\n" +
	"\fdevice.proto\x12\x06device\"W\n" +
	"\x13CreateDeviceRequest\x12\x1b\n" +
	"\ttenant_id\x18\x01 \x01(\tR\btenantId\x12#\n" +
	"\rserial_number\x18\x02 \x01(\tR\fserialNumber\"3\n" +
	"\x14CreateDeviceResponse\x12\x1b\n" +
	"\tdevice_id\x18\x01 \x01(\tR\bdeviceId2Z\n" +
	"\rDeviceService\x12I\n" +
	"\fCreateDevice\x12\x1b.device.CreateDeviceRequest\x1a\x1c.device.CreateDeviceResponseB6Z4github.com/pahuldeepp/grainguard/libs/proto;devicepbb\x06proto3"
...
var file_device_proto_goTypes = []any{
	...
	(*CreateDeviceResponse)(nil), // 1: device.CreateDeviceResponse
}
var file_device_proto_depIdxs = []int32{
	0, // 0: device.DeviceService.CreateDevice:input_type -> device.CreateDeviceRequest
	1, // 1: device.DeviceService.CreateDevice:output_type -> device.CreateDeviceResponse
